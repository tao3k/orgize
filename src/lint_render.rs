...
impl LintFinding {
    ...
    fn fix_hint(&self) -> &'static str {
        match self.code {
            ...
            "ORG027" => "set COOKIE_DATA to todo, checkbox, or direct so Org can update this statistics cookie deterministically",
    ...
    fn contract(&self) -> &'static str {
        match self.code {
            ...
            "ORG027" => "Statistics cookies should declare whether TODO, checkbox, or direct mixed progress owns the count when both evidence types are present.",
            ...
            "ORG032" => "SDD node kinds must stay in the supported architecture-description hierarchy so status projections remain deterministic.",
