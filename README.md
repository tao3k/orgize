...
Directory paths are expanded recursively to `.org` files. Formatter behavior is
covered by snapshot tests so future formatting expansions review as explicit
output diffs.
