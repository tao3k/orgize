...
scheme-test parser_lib poo_flow_lib:
    ...
    GERBIL_PATH="{{ justfile_directory() }}/target/gerbil-test" GERBIL_LOADPATH="{{ parser_lib }}:{{ poo_flow_lib }}" gerbil test languages/org/v1/parser-test.ss languages/org/v1/graph-test.ss languages/org/v1/modules/org-elements/elements-module-test.ss languages/org/v1/modules/org-contract/parser-test.ss languages/org/v1/modules/org-contract/contract-test.ss
